# Figma to Contract Checklist

- [ ] Top-level Figma frames mapped to page/route candidates.
- [ ] Route intent confirmed (or clarified once).
- [ ] Each page split into ordered sections.
